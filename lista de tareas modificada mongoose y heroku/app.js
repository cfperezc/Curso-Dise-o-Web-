...
mongoose.connect(process.env.URL_MONGO, {useNewUrlParser: true,useUnifiedTopology: true}); //ya esta la bd en la web
...
app.get("/:postName",function(require,response){
    ...
    let nombreLista= require.params.postName;  ///para que el usuario no entre con mayusculas o minusculas a la ruta se usa lodash
    nombreLista=lodash.camelCase(nombreLista);
